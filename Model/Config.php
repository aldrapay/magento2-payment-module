...
namespace Aldrapay\Aldrapay\Model;
...
class Config implements \Magento\Payment\Model\Method\ConfigInterface
{
    ...
    {
        \Aldrapay\Settings::$merchantId  = $this->getShopId();
        \Aldrapay\Settings::$passCode = $this->getShopKey();
        \Aldrapay\Settings::$pSignAlgorithm = \Aldrapay\PSignAlgorithm::$ALGO_SHA1;
        \Aldrapay\Settings::$gatewayBase = 'https://' . $this->getDomainGateway();
        \Aldrapay\Settings::$checkoutBase = 'https://' . $this->getDomainCheckout();
    }
